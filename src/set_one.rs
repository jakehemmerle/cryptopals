...
mod repeating_key_xor {
    /// This is known ciphertext generated used as an integration test
    #[allow(dead_code)]
    ...
    /// This gets challenge 1.6 ciphertext from a txt file
    #[allow(dead_code)]
    ...
    fn brute_force_dummy_data() {
        use super::rotating_key_xor_breaker::*;
...
pub mod rotating_key_xor_breaker {
    use super::utils::*;
